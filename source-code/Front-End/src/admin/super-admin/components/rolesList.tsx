...
const RolesList: React.FC<RoleListProps> = ({
  onNewTenant,
  onViewDetails,
  onEdit,
}) => {
                  ...
                  >
                    ...
                    <td className="text-center w-1/3">
                      <div className="flex justify-center items-center space-x-2">
                        ...
                        <button className="btn btn-outline btn-sm p-2 rounded hover:text-white hover:bg-sky-800  text-sky-900">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-5 w-5 mr-1"
                            fill="none"
