...
const Navbar = () => {
  ...
  return (
    <Disclosure
      ref={navRef}
      as="nav"
      className="h-[100px] text-white capitalize font-medium absolute w-full z-[5] duration-300 transition-all"
    >
      <div className="container h-full mx-auto overflow-visible py-0">
        <div className="relative h-full flex items-center justify-between">
          ...
          <div className=" inset-y-0 right-0 flex items-center pr-2 2xl:static 2xl:inset-auto 2xl:ml-6 2xl:pr-0">
            <div className=" 2xl:ml-6 2xl:block">
              <div className="flex space-x-4">
                {navigation.map((item) => (
                  <Link
                    ...
                    className={`rounded-md px-3 py-2 flex justify-center items-center hover:bg-[#5B5B5B] ${
        ...
        <div className="container overflow-visible mx-auto py-0 space-y-1 px-2 pb-5 pt-2 bg-gray-700">
          {navigation.map((item) => (
            <DisclosureButton
              ...
              to={item.to}
              aria-current={item.current ? "page" : undefined}
              className={`block rounded-md px-3 py-2 font-medium hover:bg-gray-800 ${
